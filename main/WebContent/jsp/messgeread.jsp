...
//받은메세지함
 ListModel2 listModel2 = service.listAPTSale2(requestPage, request,id);
...
<script src="//code.jquery.com/jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
...
<body>
<!--<button id="button.open.dialog">대화상자열기</button>
			...
			<div class="col-md-2">
				<div class="sidebar content-box" id="sidebarBoard"
					...
					<ul class="nav">
					    ...
					    <li><a href="javascript:popview()"><i
								class="glyphicon glyphicon-list"></i> 월세</a></li>
...
<h3>글목록 보기</h3>
	...
	<a href="insertform.jsp">받은메세지함</a>
