...
<body
	class="home singular page page-id-7 page-template page-template-page-templates page-template-business page-template-page-templatesbusiness-php " onload="focusIt()">
						...
						<div class="row">
							<div class="col-sm-6 col-sm-offset-3 form-box">
								...
								<div class="form-bottom">
									<form name="form" action="loginPro.jsp" method="post" class="login-form" onsubmit="return checkIt()">
