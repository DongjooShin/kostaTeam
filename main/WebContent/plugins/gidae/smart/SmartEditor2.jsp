...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    if(num !=null){
    	...
    	Complaint complaint =service.selectcomplaint(num);
...
<script type="text/javascript" src="../plugins/gidae/smart/js/HuskyEZCreator.js" charset="utf-8"></script>
...
nhn.husky.EZCreator.createInIFrame({
	oAppRef: oEditors,
	elPlaceHolder: "ir1",
	sSkinURI: "../plugins/gidae/smart/SmartEditor2Skin.html",	
	htParams : {
